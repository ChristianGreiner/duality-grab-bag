...
namespace ChristianGreiner.Duality.Plugins.GrabBag.Noises
{
    /// <summary>
    /// The perlin noise.
    /// </summary>
    public class PerlinNoise
    {
        ...
        public double Noise(double x, double y, double z)
        {
            ...
            return System.Math.Min(0.5, System.Math.Max(-0.5, this.Lerp(wz, vz0, vz1)));
        }
        ...
        private void InitGradients()
        {
            for (int i = 0; i < GradientSizeTable; i++)
            {
                ...
                double theta = 2 * System.Math.PI * this._random.NextDouble();
                this._gradients[i * 3] = r * System.Math.Cos(theta);
                this._gradients[i * 3 + 1] = r * System.Math.Sin(theta);
